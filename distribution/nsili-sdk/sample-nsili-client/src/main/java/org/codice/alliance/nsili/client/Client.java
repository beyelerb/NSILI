...
public class Client {
  ...
  public void runTests(String iorUrl, String emailAddress) throws Exception {
    ...
    ServiceReference<ClientBuilderFactory> serviceReference =
        bundle.getBundleContext().getServiceReference(ClientBuilderFactory.class);
    ClientBuilderFactory clientBuilderFactory =
        bundle.getBundleContext().getService(serviceReference);
    SampleNsiliClient sampleNsiliClient =
        new SampleNsiliClient(LISTEN_PORT, iorUrl, emailAddress, clientBuilderFactory);
