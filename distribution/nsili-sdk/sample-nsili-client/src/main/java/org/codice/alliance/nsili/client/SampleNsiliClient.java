...
public class SampleNsiliClient {
  ...
  public SampleNsiliClient(
      int listenPort, String iorUrl, String emailAddress, ClientBuilderFactory clientBuilderFactory)
      throws Exception {
  ...
  public String getProductIdFromDag(DAG dag) {
    DAGConverter dagConverter = new DAGConverter(new URLResourceReader(clientBuilderFactory));
