 ...
 */
package org.codice.alliance.nsili.test.itests.common;
...
public abstract class AbstractNsiliIntegrationTest extends AbstractAllianceIntegrationTest {
  ...
  protected Option[] configureStartScript() {
    ...
    return options(
        ...
        features(
            maven()
                .groupId("org.codice.alliance.nsili.test.itests.itests")
                .artifactId("nsili-test-itests-dependencies-app")
                .type("xml")
                .classifier("features")
                .versionAsInProject(),
  ...
  public static InputStream getAllianceItestResourceAsStream(String filePath) {
    return getFileContentAsStream(filePath, AbstractNsiliIntegrationTest.class);
  }
  ...
  public static String getAllianceItestResource(String filePath, ImmutableMap params) {
    return getFileContent(filePath, params, AbstractNsiliIntegrationTest.class);
  }
