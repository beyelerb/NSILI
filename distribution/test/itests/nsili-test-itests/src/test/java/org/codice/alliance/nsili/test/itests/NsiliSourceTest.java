...
public class NsiliSourceTest extends AbstractNsiliIntegrationTest {
  ...
  public String[] getDefaultRequiredApps() {
    ...
    String[] nsiliApps = Arrays.copyOf(allianceApps, allianceApps.length + 1);
